...
function redact(value, key = "") {
    ...
    if (typeof value === "string" && value.length > 1e3) return `${value.slice(0, 1e3)}…[truncated]`;
    return value;
}

export function bugLog(_scope, _message, _details) {}

export function readAppStateFromEnv({required: required = false} = {}) {
    ...
    try {
        ...
        bugLog("APPSTATE", "Loaded APPSTATE from environment", {
...
export default {
    bugLog: bugLog,
    readAppStateFromEnv: readAppStateFromEnv,
