...
export const EMOJI_PAIRS = [ [ "👍", "❤️" ], [ "😆", "😮" ], [ "😢", "😡" ], [ "🥰", "👏" ], [ "🤩", "😘" ], [ "😍", "😭" ], [ "🤔", "😅" ], [ "😁", "🥹" ], [ "🥸", "😎" ], [ "🙂", "😇" ] ];

export function attachReactionPicker({sentMessageID: sentMessageID, authorID: authorID, list: list, onPick: onPick, ttlMs: ttlMs = 12e4}) {
